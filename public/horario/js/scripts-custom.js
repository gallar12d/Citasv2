...
function guardarReserva(tipoid, eps, numeroid, nombres, apellidos, direccion, telefono, eldia, elidhorario){
      ...
      success: function(data) {
         ...
         $('.guardarhorario').on('click', function() {
            ...
            $.ajax({
               ...
               data: horariodata,
               beforeSend: function() {
                 guardarReserva(tipoid, eps, numeroid, nombres, apellidos, direccion, telefono, eldia, elidhorario);
